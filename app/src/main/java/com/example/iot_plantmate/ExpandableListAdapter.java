...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private List<String> listHeaders; // Encabezados (nombres de plantas)
    private HashMap<String, List<String>> listItems; // Contenido (sensores por planta)
    ...
    public Object getChild(int groupPosition, int childPosition) {
        return this.listItems.get(this.listHeaders.get(groupPosition)).get(childPosition);
    }
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        TextView listItemHeader = convertView.findViewById(R.id.listItemHeader);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        listItemContent.setText(childText);
        return convertView;
    }
